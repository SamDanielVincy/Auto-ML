...
if "X_train" in st.session_state and "X_test" in st.session_state:
    ...
    # Determine if the task is classification or regression based on the target variable type
    if y_train.dtype == 'object' or y_train.nunique() <= 20:  # Treat as classification
